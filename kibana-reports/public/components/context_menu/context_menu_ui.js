...
export const popoverMenu = (savedObjectAvailable) => {
  ...
  const message = savedObjectAvailable
    ? i18n.translate('odfe.reports.menu.visual.waitPrompt', { defaultMessage:'Files can take a minute or two to generate depending on the size of your source data.' })
    : i18n.translate('odfe.reports.menu.visual.savePrompt', { defaultMessage:'Save this Visualization/Dashboard to enable PDF/PNG reports.' });
             ...
             <div class="euiContextMenu" data-test-subj="shareContextMenu" style="height: ${popoverHeight}; width: 235px;">
                <div class="euiContextMenuPanel euiContextMenu__panel" tabindex="0">
                   <div class="euiPopoverTitle">
                      ...
                      ${i18n.translate('odfe.reports.menu.visual.generateReport', { defaultMessage:'Generate report' })}
                      </span>
                   </div>
                   <div>
                      ...
                      <div>
                         <${button} class="${buttonClass}" type="button" data-test-subj="downloadPanel-GeneratePDF" id="generatePDF">
                            ...
                            <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" class="euiIcon euiIcon--medium euiIcon-isLoaded euiContextMenu__icon" focusable="false" role="img" aria-hidden="true"><path d="M9 9.114l1.85-1.943a.52.52 0 01.77 0c.214.228.214.6 0 .829l-1.95 2.05a1.552 1.552 0 01-2.31 0L5.41 8a.617.617 0 010-.829.52.52 0 01.77 0L8 9.082V.556C8 .249 8.224 0 8.5 0s.5.249.5.556v8.558z"></path><path d="M16 13.006V10h-1v3.006a.995.995 0 01-.994.994H3.01a.995.995 0 01-.994-.994V10h-1v3.006c0 1.1.892 1.994 1.994 1.994h10.996c1.1 0 1.994-.893 1.994-1.994z"></path></svg>
                               <span class="euiContextMenuItem__text">${i18n.translate("odfe.reports.menu.visual.downloadPdf", { defaultMessage:"Download PDF" })}</span>
                            </span>
                         </button>
                         <${button} class="${buttonClass}" type="button" data-test-subj="downloadPanel-GeneratePNG" id="generatePNG">
                            <span class="euiContextMenu__itemLayout">
                            <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" class="euiIcon euiIcon--medium euiIcon-isLoaded euiContextMenu__icon" focusable="false" role="img" aria-hidden="true"><path d="M9 9.114l1.85-1.943a.52.52 0 01.77 0c.214.228.214.6 0 .829l-1.95 2.05a1.552 1.552 0 01-2.31 0L5.41 8a.617.617 0 010-.829.52.52 0 01.77 0L8 9.082V.556C8 .249 8.224 0 8.5 0s.5.249.5.556v8.558z"></path><path d="M16 13.006V10h-1v3.006a.995.995 0 01-.994.994H3.01a.995.995 0 01-.994-.994V10h-1v3.006c0 1.1.892 1.994 1.994 1.994h10.996c1.1 0 1.994-.893 1.994-1.994z"></path></svg>
                               <span class="euiContextMenuItem__text">${i18n.translate("odfe.reports.menu.visual.downloadPng", { defaultMessage:"Download PNG" })}</span>
                            </span>
                         </button>
                      </div>
                   </div>
                   <div class="euiPopoverTitle">
                    <span class="euiContextMenu__itemLayout">
                      ${i18n.translate("odfe.reports.menu.visual.scheduleAndShare", { defaultMessage:"Schedule and share" })}
                    </span>
                  </div>
                  <div>
                    <${button} class="${buttonClass}" type="button" data-test-subj="downloadPanel-GeneratePDF" id="createReportDefinition">
                      <span class="euiContextMenu__itemLayout">
                        ...
                        <span class="euiContextMenuItem__text">${i18n.translate("odfe.reports.menu.visual.createReportDefinition", { defaultMessage:"Create report definition" })}</span>
                        </svg>
                      </span>
                    </button>
                  </div>
                  <div class="euiPopoverTitle">
                    <span class="euiContextMenu__itemLayout">
                      ${i18n.translate("odfe.reports.menu.visual.view", { defaultMessage:"View" })}
                    </span>
                  </div>
                  <div>
                    <button class="euiContextMenuItem" type="button" data-test-subj="downloadPanel-GeneratePDF" id="viewReports">
                      <span class="euiContextMenu__itemLayout">
                        <svg id="reports-icon" width="16px" height="16px" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="euiIcon euiIcon--medium euiIcon-isLoaded euiContextMenu__icon">
                          ...
                          <span class="euiContextMenuItem__text">${i18n.translate("odfe.reports.menu.visual.viewReports", { defaultMessage:"View reports" })}</span>
                          </svg>
                      </span>
                    </button>
                    </div>
...
export const popoverMenuDiscover = (savedObjectAvailable) => {
  ...
  const message = savedObjectAvailable
    ? i18n.translate('odfe.reports.menu.csv.waitPrompt', { defaultMessage:'Files can take a minute or two to generate depending on the size of your source data.' })
    : i18n.translate('odfe.reports.menu.csv.savePrompt', { defaultMessage:'Save this search to enable CSV reports.' });
          ...
          <div>
             <div class="euiContextMenu" data-test-subj="shareContextMenu" style="height: ${popoverHeight}; width: 235px;">
                <div class="euiContextMenuPanel euiContextMenu__panel" tabindex="0">
                   <div class="euiPopoverTitle">
                      <span class="euiContextMenu__itemLayout">
                      ${i18n.translate('odfe.reports.menu.csv.generateReport', { defaultMessage:'Generate and download' })}
                      </span>
                   </div>
                   <div>
                    <span class="euiContextMenuItem__text" style="padding-left: 10px; padding-right: 10px; margin-top: 10px; box-decoration-break: clone; display: inline-block;">
                  ...
                  <div>
                    <${button} class="${buttonClass}" type="button" data-test-subj="downloadPanel-GeneratePDF" id="generateCSV">
                      <span class="euiContextMenu__itemLayout">
                        <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" class="euiIcon euiIcon--medium euiIcon-isLoaded euiContextMenu__icon" focusable="false" role="img" aria-hidden="true"><path d="M9 9.114l1.85-1.943a.52.52 0 01.77 0c.214.228.214.6 0 .829l-1.95 2.05a1.552 1.552 0 01-2.31 0L5.41 8a.617.617 0 010-.829.52.52 0 01.77 0L8 9.082V.556C8 .249 8.224 0 8.5 0s.5.249.5.556v8.558z"></path><path d="M16 13.006V10h-1v3.006a.995.995 0 01-.994.994H3.01a.995.995 0 01-.994-.994V10h-1v3.006c0 1.1.892 1.994 1.994 1.994h10.996c1.1 0 1.994-.893 1.994-1.994z"></path></svg>
                        <span class="euiContextMenuItem__text">${i18n.translate("odfe.reports.menu.csv.generateCsv", { defaultMessage:"Generate CSV" })}</span>
                        </svg>
                      </span>
                    </button>
                  </div>
                   <div class="euiPopoverTitle">
                    <span class="euiContextMenu__itemLayout">
                      ${i18n.translate("odfe.reports.menu.scheduleAndShare", { defaultMessage:"Schedule and share" })}
                    </span>
                  </div>
                  <div>
                    <${button} class="${buttonClass}" type="button" data-test-subj="downloadPanel-GeneratePDF" id="createReportDefinition">
                      <span class="euiContextMenu__itemLayout">
                        <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" class="euiIcon euiIcon--medium euiIcon-isLoaded euiContextMenu__icon" focusable="false" role="img" aria-hidden="true"><path d="M14 4v-.994C14 2.45 13.55 2 12.994 2H11v1h-1V2H6v1H5V2H3.006C2.45 2 2 2.45 2 3.006v9.988C2 13.55 2.45 14 3.006 14h9.988C13.55 14 14 13.55 14 12.994V5H2V4h12zm-3-3h1.994C14.102 1 15 1.897 15 3.006v9.988A2.005 2.005 0 0112.994 15H3.006A2.005 2.005 0 011 12.994V3.006C1 1.898 1.897 1 3.006 1H5V0h1v1h4V0h1v1zM4 7h2v1H4V7zm3 0h2v1H7V7zm3 0h2v1h-2V7zM4 9h2v1H4V9zm3 0h2v1H7V9zm3 0h2v1h-2V9zm-6 2h2v1H4v-1zm3 0h2v1H7v-1zm3 0h2v1h-2v-1z" fill-rule="evenodd"></path></svg>
                        <span class="euiContextMenuItem__text">${i18n.translate('odfe.reports.menu.createReportDefinition', { defaultMessage:'Create report definition' })}</span>
                        </svg>
                      </span>
                    </button>
                  </div>
                  <div class="euiPopoverTitle">
                    <span class="euiContextMenu__itemLayout">
                      ${i18n.translate("odfe.reports.menu.csv.view", { defaultMessage:"View" })}
                    </span>
                  </div>
                  <div>
                    <button class="euiContextMenuItem" type="button" data-test-subj="downloadPanel-GeneratePDF" id="viewReports">
                      <span class="euiContextMenu__itemLayout">
                        <svg id="reports-icon" width="16px" height="16px" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="euiIcon euiIcon--medium euiIcon-isLoaded euiContextMenu__icon">
                          ...
                          <span class="euiContextMenuItem__text">${i18n.translate('odfe.reports.menu.csv.viewReports', { defaultMessage:'View reports' })}</span>
                          </svg>
                      </span>
                    </button>
                    </div>
...
export const permissionsMissingOnGeneration = () => {
  ...
  <p class="euiScreenReaderOnly">${i18n.translate("odfe.reports.menu.newNotificationAppears", { defaultMessage:"A new notification appears" })}</p>
  <div class="euiToastHeader euiToastHeader--withBody" aria-label="Notification" data-test-subj="euiToastHeader">
    ...
    <span class="euiToastHeader__title">${i18n.translate("odfe.reports.menu.errorGeneratingReport", { defaultMessage:"Error generating report." })}</span>
  </div>
  ...
  <div class="euiText euiText--small euiToastBody">
    <p>${i18n.translate("odfe.reports.menu.insufficientPermissions", { defaultMessage:"Insufficient permissions. Reach out to your Kibana administrator." })}</p>
  </div>
  </div>
  `;
};
...
export const reportGenerationSuccess = () => {
  ...
  <div class="euiToast euiToast--success" id="reportSuccessToast">
    ...
    aria-label="Notification" data-test-subj="euiToastHeader">
      ...
      <span class="euiToastHeader__title">${i18n.translate("odfe.reports.menu.successfullyGenerated", { defaultMessage:"Successfully generated report." })}</span>
    </div>
    ...
    <div class="euiText euiText--small euiToastBody">
      <p>View
        ...
        href="opendistro_kibana_reports#/" rel="noreferrer">${i18n.translate("odfe.reports.menu.button.reports", { defaultMessage:"Reports" })}</a>.</p>
    </div>
  </div>
  `;
};
...
export const reportGenerationFailure = (
  title = i18n.translate('odfe.reports.menu.downloadError', { defaultMessage:'Download error' }),
  text = i18n.translate('odfe.reports.menu.errorGeneratingThisReport', { defaultMessage:'There was an error generating this report.' })
) => {
  return `
           ...
           <div class="euiModalHeader">
              <div class="euiText euiText--medium euiTitle euiTitle--medium">
                 <div class="euiTextAlign euiTextAlign--right">
                    <h2>${i18n.translate("odfe.reports.menu.progress.generatingReport", { defaultMessage:"Generating report" })}</h2>
                 </div>
              </div>
           </div>
           <div class="euiModalBody">
              <div class="euiModalBody__overflow">
                 <div class="euiText euiText--medium">${i18n.translate("odfe.reports.menu.progress.preparingYourFile", { defaultMessage:"Preparing your file for download." })}</div>
                 <div class="euiText euiText--medium">${i18n.translate("odfe.reports.menu.progress.youCanClose", { defaultMessage:"You can close this dialog while we continue in the background." })}</div>
