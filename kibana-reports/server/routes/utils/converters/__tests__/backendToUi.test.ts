...
const output = {
  query_url:
    "/_plugin/kibana/app/dashboards#/view/722b74f0-b882-11e8-a6d9-e546fe2bba5f?_g=(time:(from:'2020-11-11T00:32:00.000Z',to:'2020-11-11T01:02:00.000Z'))",
  ...
  report_definition: {
    report_params: {
      ...
      core_params: {
        base_url:
          '/_plugin/kibana/app/dashboards#/view/722b74f0-b882-11e8-a6d9-e546fe2bba5f',
        report_format: 'pdf',
        header: '<p>test header</p>',
        footer: '<p>fake footer</p>',
        time_duration: 'PT30M',
