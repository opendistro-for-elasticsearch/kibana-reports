...
public class MetricsTest {
    ...
    public void registerMetric() {
        ...
        Metrics.getInstance().registerMetric(new NumericMetric<Long>("test", new BasicCounter()));
    ...
    public void unRegisterMetric() {
        Metrics.getInstance().clear();
        Metrics.getInstance().registerMetric(new NumericMetric<Long>("test1", new BasicCounter()));
        Metrics.getInstance().registerMetric(new NumericMetric<Long>("test2", new BasicCounter()));
    ...
    public void getAllMetric() {
        ...
        Metrics.getInstance().registerMetric(new NumericMetric<Long>("test1", new BasicCounter()));
        Metrics.getInstance().registerMetric(new NumericMetric<Long>("test2", new BasicCounter()));
        List<Metric<?>> list = Metrics.getInstance().getAllMetrics();
