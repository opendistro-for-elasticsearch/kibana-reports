    ...
    override fun prepareRequest(request: RestRequest, client: NodeClient): RestChannelConsumer {
        ...
        return when (request.method()) {
            POST -> RestChannelConsumer {
                MyMetrics.REPORT_INSTANCE_UPDATE_TOTAL.counter.increment()
                MyMetrics.REPORT_INSTANCE_UPDATE_INTERVAL_COUNT.counter.increment()
            ...
            GET -> RestChannelConsumer {
                MyMetrics.REPORT_INSTANCE_INFO_TOTAL.counter.increment()
                MyMetrics.REPORT_INSTANCE_INFO_INTERVAL_COUNT.counter.increment()
