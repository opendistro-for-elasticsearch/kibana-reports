 ...
 * }</pre>
 */
internal data class GetReportInstanceResponse(
    ...
    companion object {
         ...
         * @return created [GetReportInstanceResponse] object
         */
        fun parse(parser: XContentParser): GetReportInstanceResponse {
            ...
            return GetReportInstanceResponse(restStatus, statusText, reportInstance)
        }
    }
