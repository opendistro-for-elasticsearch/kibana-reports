 ...
 * }</pre>
 */
internal data class UpdateReportDefinitionRequest(
    val reportDefinitionId: String,
    val reportDefinition: ReportDefinition
) : ToXContentObject {
    companion object {
        private val log by logger(UpdateReportDefinitionRequest::class.java)
         ...
         * @return created [UpdateReportDefinitionRequest] object
         */
        fun parse(parser: XContentParser, useReportDefinitionId: String? = null): UpdateReportDefinitionRequest {
            ...
            return UpdateReportDefinitionRequest(reportDefinitionId, reportDefinition)
        }
    }
